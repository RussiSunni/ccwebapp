...
app.post("/login-attempt", (req, res) => {
  ...
  if (req.body.password) {
    ...
    sqlQuery =
      "SELECT * FROM conscious_coding.users WHERE conscious_coding.users.is_admin = 1 AND conscious_coding.users.email = '" +
      req.body.email +
      "' AND conscious_coding.users.password = '" +
      req.body.password +
      "';";
    ...
    sqlQuery =
      "SELECT * FROM conscious_coding.users WHERE conscious_coding.users.is_admin = 1 AND conscious_coding.users.email = '" +
      req.body.email +
      "' AND conscious_coding.users.admin_code = '" +
      req.body.admin_code +
      "';";
  }
